		...
		<>
			<Box className="static-view-header">
				<AppBar
					...
					position="sticky"
					color="primary"
					className=" container-xxl navbar navbar-expand-lg py-0"
				>
					<Box
						component="div"
					...
					>
						...
						<IconButton
							className="navbar-toggler without-shadow"
							type="button"
						...
						>
							<Grid item xs={9}>
								<Box
									component="ul"
									className="navbar-nav me-auto mb-2 mb-lg-0 justify-content-center color-header"
								>
									<Box component="li" className="nav-item ">
										<Link
											className="nav-link active update-view-link-header header-link"
											to="/"
										>
									...
									<Box component="li" className="nav-item">
										<Link
											className="nav-link active update-view-link-header"
											to={PublicRoutes.TOPICS}
										>
									...
									<Box component="li" className="nav-item">
										<Link
											className="nav-link update-view-link-header"
											to={PublicRoutes.CALCULATOR}
										>
                  ...
                  <Box component="li" className="nav-item">
                    ...
                    */}
									<Box component="li" className="nav-item">
										<Link
											className="nav-link update-view-link-header"
											to={PublicRoutes.DISTRIBUTION_TABLES}
										>
