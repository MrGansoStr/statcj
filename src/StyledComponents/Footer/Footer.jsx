...
function Footer() {
  return (
    <Box
      component="footer"
      className="colors-footer container-xxl"
      style={{ backgroundColor: "#3C4048", color: "#fff" }}
    >
      <Box component="div" className="py-2 mt-3">
        <Grid container direction="row" spacing={3} alignItems="center">
          <Grid item xs="auto">
            <Typography component="div" variant="h4" className="p-3">
              StatCJ
            </Typography>
          </Grid>
          <Container>
      ...
      */}
      ...
      >
        ...
        <Grid item xs={4} className="boder p-2 w-25">
          <Typography
            component="div"
            variant="inherit"
            className="d-flex align-items-start justify-content-start p-2"
          >
            <MUILink
              underline="hover"
              color="inherit"
              href={PublicRoutes.COMMENTS}
              style={{ color: "#0d6efd" }}
            >
      ...
      <Container
        component="div"
        className="d-flex align-items-center justify-content-center py-3  colors-footer"
      >
