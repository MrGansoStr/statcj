...
const MainTopicTheory = lazy(
	() => import("../pages/TopicTheory/MainTopicTheory"),
);
const MediaTheory = lazy(
	() => import("../pages/TopicTheory/Media/MediaTheory"),
);
const MedianaTheory = lazy(
	() => import("../pages/TopicTheory/Mediana/MedianaTheory"),
);
const ModaTheory = lazy(() => import("../pages/TopicTheory/Moda/ModaTheory"));
const VarianceTheory = lazy(
	() => import("../pages/TopicTheory/Variance/VarianceTheory"),
);
const ErrorTheory = lazy(
	() => import("./../pages/TopicTheory/Error/ErrorTeory"),
);
