...
function Register() {
  ...
  return (
    ...
    >
      <Box
        component={Paper}
        className=" p-3 m-0 m-auto mt-5 mb-5 w-75"
        sx={{ maxWidth: 500 }}
      >
          ...
          <FormGroup className="p-3">
            ...
            <FormControl variant="standard" className="py-3">
              ...
              >
                ...
                >
                  ...
                  <MenuItem value={GenderModel.preferNotSay}>
                    Prefiero No Decirlo
                  </MenuItem>
                </Select>
              </FormControl>
            ...
            <Typography component="div" className="py-3">
              <FormControlLabel
                ...
                label="Al registrarse acepta recibir correos de nuevas funcionalidades de StatCJ."
              />
            </Typography>
            <FormControl className="py-3">
