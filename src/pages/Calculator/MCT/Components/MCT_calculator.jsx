...
export default function MCT_calculator() {
  ...
  return (
    <Stack component="div" spacing={3} className="d-flex align-items-center">
      ...
      <Box component="span" className="">
        <Button color="secondary" variant="outlined" onClick={calculateMCT}>
          Calcular
        </Button>
      </Box>
      {showError ? (
      ...
      <Box component="div">
        <Typography component="p" variant="overline" className="fs-6">
          Media:{" "}
          {calculatedValues ? <b>{calculatedValues.Media}</b> : "no Calculado"}
        </Typography>
        <Typography component="p" variant="overline" className="fs-6">
          Moda:{" "}
          {calculatedValues ? <b>{calculatedValues.Moda}</b> : "no Calculado"}
        </Typography>
        <Typography component="p" variant="overline" className="fs-6">
          Mediana:{" "}
          {calculatedValues ? (
            <b>{calculatedValues.Mediana}</b>
          ) : (
            "No calculado"
          )}
        </Typography>
