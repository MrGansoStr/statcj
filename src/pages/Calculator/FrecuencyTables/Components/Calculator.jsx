...
import {
  ...
  calculateTotals,
  ProcessData,
} from "../../../Calculations/CalculationsFrecuencyTables";
...
function Calculator() {
  ...
  const onButtonClick = useCallback(() => {
    ...
    toPng(ref.current, { cacheBust: true, Width: 600 })
      .then((dataUrl) => {
  ...
  const calculate = () => {
    if (ThereErrors(RawData)) {
      ...
      if (grouped) {
        setAmplitude({
          value: calculateAmplitud(ProcessInput(RawData)).toString(),
        });
        setInteval({
          value: calculateInterval(ProcessInput(RawData).length).toString(),
        });
  ...
  return (
    <>
      <Stack
        component="div"
        spacing={2}
        className="d-flex align-items-center justify-content-center m-0 m-auto py-5 w-75"
      >
        <Typography component="div" variant="overline" className="fs-6">
          Ingrese sus Datos separados por un espacio {'(" ")'} por dato:
        </Typography>
        <Typography component="div" variant="overline" className="fs-6">
          Ejemplo:10 2 4 5 1 2 5 1 9 2 1
        </Typography>
        <TextField
          type="text"
        ...
        <Box component="span" className="">
          <Button color="secondary" variant="outlined" onClick={calculate}>
            Calcular
          </Button>
        </Box>
        <FormControlLabel
            ...
            >
              ...
              <Grid item>
                <TextField
                  ...
                  InputProps={{
                    inputProps: {
                      min: constantInterval - 1,
                      max: constantInterval + 1,
                    },
                  }}
              ...
              <Grid item>
                <TextField
                  ...
                  InputProps={{
                    inputProps: {
                      min: constantAmplitude - 1,
                      max: constantAmplitude + 1,
                    },
                  }}
              ...
              <Grid
                item
                className=" p-1 d-flex align-items-end justify-content-end m-0 m-auto"
              >
                <Stack>
                  <Typography
                    component="span"
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="Frecuency Table">
          <TableHead>
            <TableRow>
              ...
              {grouped ? (
                <TableCell align="right">Marca de Clase</TableCell>
              ) : null}
          ...
          <TableBody>
            {processedData.map((row) => (
              ...
              >
                ...
                {grouped ? (
                  <TableCell align="right">{row.marcaDeClase}</TableCell>
                ) : null}
