  ...
  return (
    <Box component="div" className="container">
      ...
      <Typography variant="h6">
        Para datos agrupados <b>&#40;muestral&#41;</b>
      </Typography>
      <Typography component="div" variant="body1">
        <MathComponent
          tex={String.raw`Var[x] = S^2 = \frac{\sum_{i=1}^k f_i(x_i - \bar x)^2}{n-1} `}
        />
        <MathComponent
          tex={String.raw`= \frac{n}{n-1} \sum_{i=1}^k h_i (x_i- \bar X)^2`}
        />
      </Typography>
      <Typography variant="h6">
      ...
      <Typography component="div" variant="body1">
        <MathComponent
          tex={String.raw`S^2= \frac{n}{n-1} \sum_{i=1}^n (x_i- \bar X)^2`}
        />
      </Typography>
    </Box>
  );
