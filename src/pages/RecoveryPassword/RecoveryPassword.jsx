...
function RecoveryPassword() {
	...
	return (
		<Box component="div" className="container-lg mt-5 mb-5">
			<Box
				component={Paper}
				className="d-flex align-items-center justify-content-center m-0 m-auto"
				sx={{ maxWidth: 550 }}
			>
				<form className="mt-5 mb-5 w-100 p-4" onSubmit={RecoveryAccount}>
					<Typography variant="h6">
						Ingrese su email para verificar su identidad
					</Typography>
				...
				>
					<BootstrapDialogTitle onClose={HideModal}>
						<Typography variant="overline" className="fs-4 mx-4">
					...
					<DialogContent dividers>
						...
						{errorInModal ? (
							<Box component="div" className="p-3">
								<StyledErrorInput show={errorInModal} HideError={HideError} />
							</Box>
						) : null}
						<DialogActions>
							<Button
